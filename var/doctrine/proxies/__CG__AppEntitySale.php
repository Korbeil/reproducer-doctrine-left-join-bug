...
class Sale extends \App\Entity\Sale implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Sale' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Sale' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Sale' . "\0" . 'categories', '' . "\0" . 'App\\Entity\\Sale' . "\0" . 'products'];
        }
     ...
     * {@inheritDoc}
     */
    public function setProducts(\Doctrine\Common\Collections\Collection $products): void
    {
